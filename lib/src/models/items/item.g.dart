...
const ItemSchema = IsarGeneratedSchema(
  ...
  converter: IsarObjectConverter<void, Item>(
...
int serializeItem(IsarWriter writer, Item object) {
  ...
  IsarCore.writeString(writer, 4, object.effect);
  return 0;
}
...
Item deserializeItem(IsarReader reader) {
  final ItemType _type;
  {
    if (IsarCore.readNull(reader, 1)) {
      _type = ItemType.nothing;
    } else {
      _type = _itemType[IsarCore.readByte(reader, 1)] ?? ItemType.nothing;
    }
  }
  final String _name;
  ...
  _effect = IsarCore.readString(reader, 4) ?? '';
  final object = Item(
    type: _type,
    name: _name,
...
extension ItemQueryFilter on QueryBuilder<Item, Item, QFilterCondition> {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> descriptionLessThanOrEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectGreaterThan(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectGreaterThanOrEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectLessThan(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectLessThanOrEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectBetween(
    String lower,
    String upper, {
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        ContainsCondition(
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        MatchesCondition(
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const EqualCondition(
          property: 4,
  ...
  QueryBuilder<Item, Item, QAfterFilterCondition> effectIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const GreaterCondition(
          property: 4,
